...
class AWBGenerator {
    ...
    addLabelContent(doc, order, shipment, awbDetails, options) {
        ...
        doc.fontSize(8).font('Helvetica').text(BRAND.legalName, 10, 95);
    ...
    addDocumentContent(doc, order, shipment, awbDetails, options) {
        ...
        doc.fontSize(10).font('Helvetica').text(BRAND.legalName, 50, 160);
        ...
        doc.fontSize(10).text(`Email: ${BRAND.supportEmailAlt}`, 50, 235);
