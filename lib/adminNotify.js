...
const COLORS = {
    ...
    payment_late_ignored: 'linear-gradient(135deg,#7c2d12,#fb923c)',
    orders_auto_cancelled: 'linear-gradient(135deg,#b91c1c,#ef4444)',
    orders_auto_confirmed: 'linear-gradient(135deg,#1d4ed8,#60a5fa)',
...
async function notifyAllAdmins(payload) {
    try {
        ...
        const dedupeWindowMs = Math.max(0, Number(payload.dedupeWindowMs || 0));
